...
def main(
    ...
    mapping = {
        ...
        "ETTh2": {"root_path": "./dataset/ETT-small", "data_path": "ETTh2", "data": "ETTh2", "task_id": "ETTh2", "variant_num": 7, "lr_range": [2, 5, 10, 20], "lr_range_ets": [200, 300, 500, 1000, 1500], "lr_range_cross": [200, 300, 500, 1000], "K": 3, "lr_ets": 1e-5, "lr_cross": [3e-5]*4, "seq_len_ets": 96, "seq_len_cross": [336,720,720,720], "seg_len_cross": [12,24,24,24], "d_model": 256, "d_ff":512, "e_layers": 3, "n_heads": 4},
        "ETTm1": {"root_path": "./dataset/ETT-small", "data_path": "ETTm1", "data": "ETTm1", "task_id": "ETTm1", "variant_num": 7, "lr_range": [10, 20, 50], "lr_range_ets": [2, 5, 10, 20, 50], "lr_range_cross": [2, 5, 10, 20, 50], "K": 3, "lr_ets": 1e-5, "lr_cross": [1e-4]*4, "seq_len_ets": 96, "seq_len_cross": [672,672,672,672], "seg_len_cross": [12,24,24,24], "d_model": 256, "d_ff":512, "e_layers": 3, "n_heads": 4},
        "ETTm2": {"root_path": "./dataset/ETT-small", "data_path": "ETTm2", "data": "ETTm2", "task_id": "ETTm2", "variant_num": 7, "lr_range": [5, 10, 20], "lr_range_ets": [50, 100, 200, 500], "lr_range_cross": [10, 20, 50, 100, 200], "K": 3, "lr_ets": 1e-5, "lr_cross": [1e-4]*4, "seq_len_ets": 96, "seq_len_cross": [672,672,672,672], "seg_len_cross": [12,24,24,24], "d_model": 256, "d_ff":512, "e_layers": 3, "n_heads": 4},
        ...
        "Weather": {"root_path": "./dataset/weather", "data_path": "weather", "data": "custom", "task_id": "weather", "variant_num": 21, "lr_range": [10, 20, 30], "lr_range_ets": [5, 10, 20, 50], "lr_range_cross": [5, 10, 20], "K": 3, "lr_ets": 3e-4, "lr_cross": [3e-5]*4, "seq_len_ets": 336, "seq_len_cross": [336,336,336,720], "seg_len_cross": [12,24,24,24], "d_model": 256, "d_ff":512, "e_layers": 3, "n_heads": 4},
        "Illness": {"root_path": "./dataset/illness", "data_path": "national_illness", "data": "custom", "task_id": "ili", "variant_num": 7, "lr_range": [2, 5, 10, 20, 50, 100, 150], "lr_range_ets": [0.2, 0.5, 1, 2, 5], "lr_range_cross": [5, 10, 20, 50, 70, 100], "K": 1, "lr_ets": 1e-3, "lr_cross": [5e-4]*4, "seq_len_ets": 60, "seq_len_cross": [48,48,60,60], "seg_len_cross": [6,6,6,6], "d_model": 256, "d_ff":512, "e_layers": 3, "n_heads": 4},
    }
